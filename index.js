...
// ROCK WINS!
    ...
    document.querySelector('.p1').innerHTML = "<strong> Player 1 Wins!</>";
} else if (randomImage1 === scissor && randomImage2 === rock) {
    // ROCK WINS!
    document.querySelector('h1').textContent = "ROCK WINS!";
    document.querySelector('.p1').innerHTML = " Player 1 Sorry You Loose ";
    ...
    document.querySelector('.p2').innerHTML = "Player 2 Sorry You Loose";
